...
const exchange_name = 'btc38'
const timeout = 8000

function Btc38(options) {
  this.base = options.base
  this.counter = options.counter
  this.url = config.get('apis:btc38') + '/v1/depth.php'
}
 ...
 */
Btc38.prototype.pullOrderBook = function() {
  ...
  /*
   * call Btc38 api to get a snapshot of latest orderbook
  ...
  function getSnapshot(object) {
    const url = object.url + '?c=' + object.base.toLowerCase()
    // console.log(url)
    return request({
      url: url,
      json: true,
