...
const exchange_name = 'korbit'
const timeout = 8000

function Korbit(options) {
  this.base = options.base
  this.counter = options.counter
  this.url = config.get('apis:korbit') + '/v1/orderbook'
}
 ...
 */
Korbit.prototype.pullOrderBook = function() {
  ...
  /*
   * call Korbit api to get a snapshot of latest orderbook
  ...
  function getSnapshot(object) {
    ...
    const url = object.url + '?currency_pair=' + pair
