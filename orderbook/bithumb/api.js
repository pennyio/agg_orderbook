...
function Bithumb(options) {
  ...
  this.url = config.get('apis:bithumb') + '/public/orderbook'
}
 ...
 */
Bithumb.prototype.pullOrderBook = function() {
  ...
  function getSnapshot(object) {
    ...
    return request({
      ...
      const sortedBids = orderbook.data.bids.sort(function(a, b) {
        return Number(b.price) - Number(a.price)
      })

      // sort asks in ascending order
      // lowest ask comes first
      const sortedAsks = orderbook.data.asks.sort(function(a, b) {
