...
const exchange_name = 'jubi'
const timeout = 8000

function Jubi(options) {
  this.base = options.base
  this.counter = options.counter
  this.url = config.get('apis:jubi') + '/api/v1/depth'
}
 ...
 */
Jubi.prototype.pullOrderBook = function() {
  ...
  /*
   * call Jubi api to get a snapshot of latest orderbook
  ...
  function getSnapshot(object) {
    ...
    const url = object.url + '?coin=' + pair
